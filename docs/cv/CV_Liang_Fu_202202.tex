...
\address{\small Last updated: Feb. 2022}
...
``Monetary Policy Surprises and Interest Rates under China's Evolving Monetary Policy Framework'' (with \href{https://sites.google.com/site/chunyuho}{\color{black}{Chun-Yu Ho}}) \textit{\color{blue}{\textbf{\underline{Emerging Markets Review}}}}, \textbf{Conditionally Accepted}.
\vspace{0.1cm} \\
``Political Stability and Credibility of Currency Boards'' (with Shu Feng, Chun-Yu Ho, and Wai-Yip Alex Ho)  \textit{\color{blue}{\underline{\textbf{Journal of International Money and Finance}}}}, \textbf{Revised and Resubmitted}.
\vspace{0.1cm} \\
...
%	\textbf{``Monetary Policy Surprises and Interest Rates under China's Evolving Monetary Policy Framework''} (with Chun-Yu Ho) \textit{\color{blue}{\textbf{\underline{Emerging Markets Review}}}}, \textit{Conditionally Accepted}.\vspace{0.1cm}\\ 
...
%	
%	\textbf{``Political Stability and Credibility of Currency Boards''} (with Shu Feng, Chun-Yu Ho, and Wai-Yip Alex Ho) \textit{\color{blue}{\textbf{\underline{Journal of International Money and Finance}}}}, \textit{Revised and Resubmitted}.\vspace{0.1cm}\\
